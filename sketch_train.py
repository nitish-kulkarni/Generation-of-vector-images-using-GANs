...
def load_env(data_dir, model_dir):
  ...
  model_params = sketch_model.get_default_hparams()
...
def load_model(model_dir):
  ...
  sample_model_params = sketch_model.copy_hparams(eval_model_params)
...
def trainer(model_params):
  ...
  reset_graph()
  model = sketch_model.Model(model_params)
  eval_model = sketch_model.Model(eval_model_params, reuse=True)
